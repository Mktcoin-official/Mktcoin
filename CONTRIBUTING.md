Contributing to MktCoin Core
============================

The MktCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MktCoin Core project, and is not to be
confused with overall MktCoin Network Protocol consensus changes.

Whether a pull request is merged into MktCoin Core rests with the project merge
...
Patches that change MktCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MktCoin consensus, it must have been
...
The project leader is the release manager for each MktCoin Core release.
