...
RESOURCES += src/qt/mktcoin.qrc src/qt/mktcoin_locale.qrc

TRANSLATIONS += src/qt/locale/mktcoin_bg.ts \
                src/qt/locale/mktcoin_de.ts \
                src/qt/locale/mktcoin_en.ts \
                src/qt/locale/mktcoin_es.ts \
                src/qt/locale/mktcoin_fi.ts \
                src/qt/locale/mktcoin_fr.ts \
                src/qt/locale/mktcoin_it.ts \
                src/qt/locale/mktcoin_ja.ts \
                src/qt/locale/mktcoin_pl.ts \
                src/qt/locale/mktcoin_pt.ts \
                src/qt/locale/mktcoin_ru.ts \
                src/qt/locale/mktcoin_sk.ts \
                src/qt/locale/mktcoin_sv.ts \
                src/qt/locale/mktcoin_vi.ts \
                src/qt/locale/mktcoin_zh_CN.ts \
                src/qt/locale/mktcoin_zh_TW.ts
