...
In order to support loading of multiple wallets in mktcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mktcoin.cpp.

Finally, two new headers and source files will have to be added to mktcoin-qt.pro.
...
Changes to mktcoin.cpp
----------------------
mktcoin.cpp is the entry point into mktcoin-qt, and as such, will require some minor modifications to provide hooks for
