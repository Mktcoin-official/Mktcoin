...
/** 
    ...
    ****Note - for MktCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of mktcoins coming in to a transaction
