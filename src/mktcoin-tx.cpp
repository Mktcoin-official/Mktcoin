...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MktCoin Core mktcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mktcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mktcoin transaction") + "\n" +
                               "  mktcoin-tx [options] -create [commands]   " + _("Create hex-encoded mktcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mktcoin transaction
