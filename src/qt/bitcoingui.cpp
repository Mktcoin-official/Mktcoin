                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MktCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a mktcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mktcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MktCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MktCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for mktcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your mktcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified mktcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a mktcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MktCoin Core help message to get a list with possible MktCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MktCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MktCoin network", "", count));
}
...
{
    QString strTitle = tr("MktCoin Core"); // default title
