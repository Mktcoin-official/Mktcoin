...
/** Utility functions used by the MktCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render mktcoin addresses in monospace font
...
// Parse "mktcoin:" URI into recipient object, return true on successful parsing
